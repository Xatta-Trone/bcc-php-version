	...
	<div class="team-section">
		<div class="page-meta">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<span>Home / Programs / Women Wing</span>
						<h2>Women Wing</h2>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="programe-slides">
						...
						<?php $getAllSlides = $slider->getSlideByProgramme(5); ?>
...
<?php $getProgrammeDescription = $programme->getProgrammeById(5) ?>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="user-posts text-center section-padding">
					<h1>Recent Events on Women Wing</h1>
					<div class="row no-gutters h-100">

<?php $getAllPost = $post->getAllPostByProgramme(5); ?>
