...
<?php if (isset($_GET['delid'])) {
	$deleteMemberById = $Moderator->deleteMemberById($_GET['delid']);
} ?>
...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Moderator List</div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
<?php $getAllMembers = $Moderator->getAllMembers(); ?>
<?php if ($getAllMembers):
		...
		foreach ($getAllMembers as $value): ?>
                ...
                <tr>
                  ...
                  <td>
                  	<a href="modedit.php?id=<?php echo $value['id'];?>" class="btn btn-xs btn-primary">Edit</a> 
                  	|| 
