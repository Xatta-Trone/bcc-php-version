...
<?php $userlevel = new Area(); ?>
<?php 
	if (($_SERVER['REQUEST_METHOD']=='POST') && isset($_POST['addarea'])) {
		$areaInsert = $userlevel->addArea($_POST);
	}
		...
		<div class="col-md-12">
			<form method="POST" >
				<div class="form-group row">
				  <label class="col-2 col-form-label">Add new Area</label>
				  <div class="col-10">
				...
				<div class="form-group row">
				  ...
				  <div class="col-10 col-md-offset-2">
				    <input type="submit" name="addarea" value="Add" class="btn btn-primary">
				  </div>
				</div>
			</form>
		</div>
