	...
	<div class="team-section">
		<div class="page-meta">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<span>Home / Programs / DEA</span>
						<h2>BUET Duke of Edinburgh's Award</h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="programe-slides">
						...
						<?php $getAllSlides = $slider->getSlideByProgramme(4); ?>
...
<?php $getAllPost = $post->getAllPostByProgramme(4); ?>
