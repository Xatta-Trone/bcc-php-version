	...
	<div class="news-event-wrapper section-padding">
		<div class="container">
			<div class="row no-gutters h-100">
				<?php $getAllPost = $post->getLimitedPost(12,$start_from); ?>
...
<?php $pagination =  $post->Pagaination(); ?>
					...
					<ul class="pagination justify-content-center">
						<li><a href="blog.php?page=1"><i class="fa fa-chevron-left"></i></a></li>
<?php for ($i=1; $i <=$pagination; $i++): ?>
						<li><a href="blog.php?page=<?= $i ;?>" <?php if ($page==$i) {echo "class='active'";} ?>><?= $i; ?></a></li>
<?php endfor; ?>
						<li><a href="blog.php?page=<?=$pagination ?>"><i class="fa fa-chevron-right"></i></a></li>
					</ul>
				</div>
			</div>
		</div>
